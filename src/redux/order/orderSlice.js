...
export const orderSlice = createSlice({
    ...
    reducers: {   
        ...
        applyVoucher: (state, action) => {
            ...
            const discountAmount = (totalAmount - voucher.giamGia) // tiền đơn hàng - giảm giá
            state.appliedDiscount = discountAmount + 30000;
            ...
            notification.success({
                message: 'Voucher đã được áp dụng',
                description: `Giảm giá ${Number(voucher.giamGia).toLocaleString()}đ cho đơn hàng.`,
            });
        },
        ...
        doAddAction: (state, action) => {
            ...
            state.appliedDiscount = state.totalPriceChuaGiam + 30000
